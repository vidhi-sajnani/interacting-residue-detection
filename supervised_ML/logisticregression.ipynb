 ...
 "cells": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "zOU_PAouQ1i5",
    "outputId": "57da365f-8c21-47f8-9a75-dfa762fdc423"
   },
   "outputs": [
    {
     "data": {
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "h1pCbvVLyZ7F",
    "outputId": "db689bef-60df-4c5e-a913-16f83a618efb"
   },
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      ...
      "\n",
      "         0.0       0.90      1.00      0.95      3236\n",
      "         1.0       0.00      0.00      0.00       363\n",
      "\n",
      "    accuracy                           0.90      3599\n",
      "   macro avg       0.45      0.50      0.47      3599\n",
      "weighted avg       0.81      0.90      0.85      3599\n",
      "\n"
     ]
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "C:\\Users\\Vidhi Sajnani\\AppData\\Local\\Programs\\Python\\Python310\\lib\\site-packages\\sklearn\\linear_model\\_logistic.py:460: ConvergenceWarning: lbfgs failed to converge (status=1):\n",
      ...
      "C:\\Users\\Vidhi Sajnani\\AppData\\Local\\Programs\\Python\\Python310\\lib\\site-packages\\sklearn\\metrics\\_classification.py:1469: UndefinedMetricWarning: Precision and F-score are ill-defined and being set to 0.0 in labels with no predicted samples. Use `zero_division` parameter to control this behavior.\n",
